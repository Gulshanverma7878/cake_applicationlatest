...
const CakeDetailPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    const url = `https://chat.kashishindiapvtltd.com/send-message?sender=918529670548&number=${mobile}&message=I want to order ${quantity} ${name} cake(s) for ₹${price} each.&api_key=gby8vpJ3fvdMIIHvcahaQcZ0t7ktlA`;
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 relative">
      ...
      {tag && (
        <span className="text-sm bg-yellow-300 text-black px-2 py-1 rounded inline-block mt-2">
          {tag}
        </span>
      )}
